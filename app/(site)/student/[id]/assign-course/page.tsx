    ...
    <>
      ...
      {getStudent?.isPending ? (
        ...
        <div className='p-3 mt-2 mb-10 flex flex-wrap flex-col md:flex-row gap-2'>
          ...
          <div className=' bg-white rounded p-2 min-w-[19%]'>
            <h1 className=''>{student?.name}</h1>
            <p className=''>{student?.rollNo}</p>
            <p className='font-light'>{student?.mobile}</p>
            <p className='font-light'>{student?.district}</p>
          </div>

          <div className=' bg-white rounded p-2 min-w-[19%] font-light'>
            <h1>{student?.placeOfBirth}</h1>
          ...
          <div className=' bg-white rounded p-2 min-w-[19%] font-light'>
            <h1>So. {student?.somaliLanguage}</h1>
            <p>AR. {student?.arabicLanguage}</p>
            <p>EN. {student?.englishLanguage}</p>
            <p>KE. {student?.kiswahiliLanguage}</p>
          </div>

          <div className=' bg-white rounded p-2 min-w-[19%] font-light'>
            <h1>{student?.contactName}</h1>
            <p>{student?.contactMobile}</p>
            <p>{student?.contactEmail}</p>
            <p>{student?.contactRelation}</p>
          </div> */}
        </div>
      )}
