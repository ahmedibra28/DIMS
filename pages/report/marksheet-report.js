import { getMarkSheetReport } from '../../api/report'
...
const MarkSheetReport = () => {
  ...
  } = useMutation(['getMarkSheetReport'], getMarkSheetReport, {
    retry: 0,
    onSuccess: () => {},
  })
  ...
  return (
    <div>
      <Head>
        ...
        <meta property='og:title' content='Marksheet Report' key='title' />
      </Head>
...
export default dynamic(() => Promise.resolve(withAuth(MarkSheetReport)), {
  ssr: false,
})
